  ...
  return (
    <div className="flex flex-col px-30 pb-30 gap-2 pt-24">
      ...
      <div className="flex gap-3 ">
        <div className="border border-[#dadada] rounded-md overflow-scroll p-3 flex flex-col gap-2 min-h-96 max-h-96 min-w-96 max-w-96">
          <ul className="">
        ...
        <div className="border border-[#dadada] rounded-md overflow-scroll p-3 flex flex-col justify-between gap-4 text-center min-h-96 max-h-96 min-w-96 max-w-96">
